...
export const projects: Project[] = [
  {
    ...
    description:
      "A web application that enables real-time video communication using the Agora platform.",
    techStack: ["Django", "JavaScript"],
    image: "/projectImage/video-chat-website-django.png?height=300&width=400",
    githubUrl: "https://github.com/shuva-kharel/video-chat-website",
    liveUrl: "https://demo.shuvakharel.com.np",
    category: "web",
  },
  // {
  //   id: 2,
